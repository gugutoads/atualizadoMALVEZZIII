...
public class BancoController {
    ...
    public void cadastrarFuncionario(String nome, String cargo) {
        if (nome.isEmpty() || cargo.isEmpty()) {
            throw new IllegalArgumentException("Nome e Cargo devem ser preenchidos.");
        }
    ...
    // Método que abre o formulário de cadastro de funcionário
    public void abrirFormularioCadastroFuncionario() {
        new FormularioCadastroFuncionario(this); // Chama a interface gráfica
    }


    // Método para abrir o formulário de consulta
    public void abrirFormularioConsultarConta() {
        new FormularioConsultarConta(this); // Passa o controlador para o formulário
    }

    // Método para abrir o formulário de encerrar conta
    public void abrirFormularioEncerrarConta() {
        new FormularioEncerrarConta(this); // Passa o controlador para o formulário
    }
